	...
	render() {
		...
		return (
			<div style={styles.loginCard}>
				...
				<form onSubmit={this.handleLoginUser} autoComplete="new-password" noValidate>
					<TextField
						id="email"
						label="Email"
				...
				<div style={styles.guest}>
					To test, enter 'guest@gmail.com' as the username and 'password' as the password.
				</div>
				<div style={styles.errorMessage}>{errors ? errors.msg : ''}</div>
